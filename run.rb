...
::Trace.default_endpoint = ::Trace::Endpoint.new(::Trace::Endpoint.host_to_i32('127.0.0.1'), 0, 'finagle-ruby')
::FinagleThrift.enable_tracing!(client, ::FinagleThrift::ClientId.new(name: 'ruby-finagle-thrift-client-example'))
